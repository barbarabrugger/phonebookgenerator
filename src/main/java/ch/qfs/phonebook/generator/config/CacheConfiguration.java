package ch.qfs.phonebook.generator.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ch.qfs.phonebook.generator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ch.qfs.phonebook.generator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
