...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONEBOOKENTRY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONEBOOKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONEBOOKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONEBOOKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONEBOOKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONEBOOKENTRY actions', async () => {
      const expectedActions = [
        {
