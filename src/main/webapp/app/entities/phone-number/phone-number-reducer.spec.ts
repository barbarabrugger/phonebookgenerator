...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONENUMBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONENUMBER actions', async () => {
      const expectedActions = [
        {
